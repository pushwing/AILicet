...
final class ActivationController
{
    ...
    #[OA\Post(path: '/api/v1/floating/activation', summary: '플로팅 활성화', security: [['bearerAuth' => []]], tags: ['Floating'], responses: [
        new OA\Response(response: 200, description: '활성화 결과(activated/token)'),
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return $this->json->success($this->service->activation($licenseKey, $hostId));
    }
}
