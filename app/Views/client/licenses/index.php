...
<div class="page-head"><h1 class="page-head__title">내 라이센스</h1><p class="page-head__desc">내게 발급된 라이센스입니다.</p></div>
...
<div class="card"><div class="card__body">
    ...
    <div id="grid" class="ag-theme-alpine" style="height:440px;"></div>
...
<script>
    ...
    let api = agGrid.createGrid(document.getElementById('grid'), {
        columnDefs: [
            { field: 'product_name', headerName: '상품', flex: 1.2 },
            ...
            { headerName: '', flex: 0.5, sortable: false, cellRenderer: p => `<a class="btn btn--ghost" style="padding:4px 10px" href="/client/licenses/${p.data.id}">보기</a>` },
        ],
    ...
    async function reload(page) {
        ...
        const json = await (await fetch(`/client/licenses/data?${params}`)).json();
